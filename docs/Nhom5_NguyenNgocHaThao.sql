...
-- =========================================================================
-- PHẦN 2.2: TẠO CÁC BẢNG DỮ LIỆU (DDL) VÀ RÀNG BUỘC TOÀN VẸN
-- =========================================================================
...
-- =========================================================================
-- PHẦN 2.2: TẠO CÁC INDEX TỐI ƯU TRUY XUẤT HIỆU NĂNG CAO
-- =========================================================================
...
-- =========================================================================
-- PHẦN 2.2: NẠP DỮ LIỆU MẪU (SEED DATA > 1.000 RECORDS)
-- =========================================================================
...
-- =========================================================================
-- KIỂM TRA TỔNG HỢP SỐ LƯỢNG BẢN GHI
-- =========================================================================
SELECT 'loai_mon' AS `table_name`, COUNT(*) AS `record_count` FROM `loai_mon`
UNION ALL
SELECT 'mon_an', COUNT(*) FROM `mon_an`
UNION ALL
...
UNION ALL
SELECT 'nguyen_lieu', COUNT(*) FROM `nguyen_lieu`
UNION ALL
SELECT 'nha_cung_cap', COUNT(*) FROM `nha_cung_cap`
UNION ALL
SELECT 'dat_ban_truoc', COUNT(*) FROM `dat_ban_truoc`
UNION ALL
SELECT 'dat_mon', COUNT(*) FROM `dat_mon`;
